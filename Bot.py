...
async def handle_media(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Default: broadcast to VIP — each user gets watermark with their own ID
...
async def feedback_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    SHORT = [
        ...
        f"Not one loss today bro 🎯",
        f"${amt1} and it's not even afternoon 💰",
        f"Bro Evalon hits different every time 🔥",
        f"Session was clean start to finish king 👑",
        f"Every entry was spot on today bro 💪",
        f"${amt1} made. Simple follow and profit 🎯",
        f"This accuracy is unreal bro. ${amt1} 💎",
    ...
    LONG = [
        ...
        f"Evalon is built different king 💎",

        f"Bro I follow every signal without hesitation now. "
        ...
        # Swahili — 1 only
        f"Nimekuwa nikifuata signals kwa wiki mbili sasa. "
        f"Kila session inanipa faida. Leo ${amt1} tena. Asante 🙏",
    ]
